 ...
 * 
 */
@WebServiceClient(name = "TimeCatcherService", targetNamespace = "http://tracktime.zetweb.com.ua/ws-test/"
, 	wsdlLocation = "file:/home/dimon/Development/EclipseWorkspace/Mars/TimeTracker/src/main/resources/set-2.wsdl"
	)
    ...
    extends Service
{
    ...
    static {
       ...
       // try {
          //  url = new URL("file://service.wsdl");
        	 url = TimeCatcherService.class.getResource("service.wsdl");
